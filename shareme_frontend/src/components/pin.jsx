...
const Pin = ({ pin: { postedBy, image, _id, destination, save } }) => {
  ...
  // Determine if the pin is already saved
            ...
            <div className="flex justify-between items-center gap-2 w-full">
              {destination && (
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  className="bg-white flex gap-2 items-center text-black font-bold p-2 pl-4 pr-4 rounded-full opacity-70 hover:opacity-100 hover:shadow-md"
                >
